...
foreach(COMP ${HAL_FIND_COMPONENTS})
    ...
    string(REGEX MATCH "^STM32([CFGHLMUW]P?[0-9BL])([0-9A-Z][0-9M][A-Z][0-9A-Z])?_?(M0PLUS|M4|M7|M33)?.*$" COMP_U ${COMP_U})
...
foreach(family_comp ${HAL_FIND_COMPONENTS_FAMILIES})
    ...
    string(REGEX MATCH "^STM32([CFGHLMUW]P?[0-9BL])([0-9A-Z][0-9M][A-Z][0-9A-Z])?_?(M0PLUS|M4|M7|M33)?.*$" family_comp ${family_comp})
    if(CMAKE_MATCH_1) #Matches the family part of the provided STM32<FAMILY>[..] component
...
if(STM32H5 IN_LIST HAL_FIND_COMPONENTS_FAMILIES)
    list(REMOVE_ITEM HAL_FIND_COMPONENTS_FAMILIES STM32H5)
    list(APPEND HAL_FIND_COMPONENTS_FAMILIES STM32H5_M33)
endif()
